/*
 * 2014.11.06 datepicker
 * line 3824 add
 * maxDate: new Date(new Date().getFullYear()+25,12,31),//naon gw6.0 custom
 * why : 그룹웨어에서 달력 날짜를 올해로부터 25년 까지만 사용하도록함.
 * 사용자가 5555년 데이터를 넣을 수 있는 것을 방지.
 * 
 */
...
function Datepicker() {
	...
	this._defaults = { // Global defaults for all the date picker instances
		...
		maxDate: new Date(new Date().getFullYear()+25,12,31), // The latest selectable date, or null for no limit //naon gw6.0 custom
