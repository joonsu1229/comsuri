...
(function ($, undefined) {
	...
	function isMail(text) {
		...
		var mailPattern = /^[a-zA-Z0-9.+'_-]+@([-0-9a-zA-Z]+[.])+[a-zA-Z]{2,6}/g;
        ...
        selectHighlighted: function () {
         ...
         // jgs135 엔터키 입력 시 검색 결과가 없을 경우에도 추가 되도록 수정
            if (data) {
            	...
            	if(this.opts.ajax.data().typeSearch == 'E'){
    ...
    $.fn.select2 = function () {
        ...
        var args = Array.prototype.slice.call(arguments, 0),
            opts,
            select2,
            value, multiple, allowedMethods = ["val", "destroy", "opened", "open", "close", "focus", "isFocused", "container", "onSortStart", "onSortEnd", "onSortStop", "enable", "disable", "positionDropdown", "data"];
        this.each(function () {
	    ...
	    $.fn.mailList.defaults = {
			...
			tokenizer : function(input, selection, selectCallback, opts) {
		        ...
		        while (true) {
		            ...
		            if (token.length > 0) {
		            	token = $.trim(token);
		            	if(opts.ajax.data().typeSearch == 'E'){
