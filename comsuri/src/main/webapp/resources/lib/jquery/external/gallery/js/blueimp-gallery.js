...
(function (factory) {
    ...
    function Gallery(list, options) {
        ...
        //로드 할 다음 이미지가 있는가? @author jgs135
        this.existNextImages = true;
        //로드 할 이전 이미지가 있는가? @author jgs135
        this.existPrevImages = true;
    ...
    $.extend(Gallery.prototype, {
        ...
        addBefore: function (list) {
            ...
            this.container
                .removeClass(this.options.leftEdgeClass)
                .removeClass(this.options.singleClass);
        ...
        setTitle: function (index) {
            ...
            var text = this.list[index][this.options.titleProperty],
            ...
            if (titleElement.length) {
                ...
                if (text) {
                	...
                	//여기서 $는 blueimp-help객체를 의미하여 jQuery로 변경하여 사용함 @author jgs135
                	jQuery(titleElement[0]).html(text);
                }
            }
        },
        ...
        imageFactory: function (obj, callback) {
            ...
            // jgs135 갤러리 이미지 태그에 타이틀을 제거 한다. 이유는 title에 HTML코드가 들어갈 수도 있기 때문이다.
            /*
            if (title) {
                element.title = title;
            }
