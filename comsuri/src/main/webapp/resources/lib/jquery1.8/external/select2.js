	   ...
	   $.fn.mailList = function () {
	    ...
	    $.fn.mailList.defaults = {
			...
			formatNoMatches : function() {
				return eml_desc_searchResultDesc; // 다국어 처리 필요
			},
	        formatNoMatches: function () { return eml_desc_searchResultDesc; },
	        formatInputTooShort: function (input, min) { return (min - input.length) + eml_desc_autoSearch1; },
	        formatSelectionTooBig: function (limit) { return limit + eml_desc_autoSearch2; },
