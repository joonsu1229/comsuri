 ...
 * Revision: jQueryId: jquery.simplemodal.js 261 2010-11-05 21:16:20Z emartin24 jQuery
 */
	...
	jQuery.modal.impl = {
		...
		create: function (data) {
			...
			s.d.container = jQuery('<div></div>')
				...
				.css(jQuery.extend(s.o.containerCss, {
					display: 'none',
					position: 'fixed',
					zIndex: s.o.zIndex + 2
				}))
		...
		bindEvents: function () {
			...
			// bind keydown events
			jQuery(document).bind('keydown.simplemodal', function (e) {
		...
		unbindEvents: function () {
			...
			jQuery(document).unbind('keydown.simplemodal');
		...
		fixIE: function () {
			...
			jQuery.each([s.d.iframe || null, !s.o.modal ? null : s.d.overlay, s.d.container], function (i, el) {
				if (el) {
		...
		getDimensions: function () {
			...
			var h = jQuery.browser.opera && jQuery.browser.version > '9.5' && jQuery.fn.jquery < '1.3'
		...
		setPosition: function () {
			var s = this, top, left,
				hc = (w[0]/4) - (s.d.container.outerHeight(true)/2),
		...
		getPosition: function (pos) {
			...
			if(pos == 'x') return s.d.container.css('left');
			else if(pos == 'y') return s.d.container.css('top');
		},
		watchTab: function (e) {
			var s = this;
